...
export default function App() {
  ...
  const navItems = [
    { id: 'menu-update', label: 'Menu Update', icon: LayoutDashboard, color: 'text-red-600' },
  ...
  return (
    <div className="flex min-h-screen bg-[#FDF5EE] text-[#1A0806] font-sans selection:bg-red-100 selection:text-red-600 overflow-hidden">
      ...
      {/* Sidebar */}
      <aside className="w-72 bg-white/80 backdrop-blur-xl border-r border-red-100 flex flex-col fixed left-0 top-0 h-screen overflow-hidden z-50 shadow-xl shadow-red-900/5">
      ...
      {/* Main Content */}
      <main className="flex-1 min-w-0 overflow-y-auto relative z-10 ml-72">
        <header className="h-24 bg-white/70 backdrop-blur-md border-b border-red-50/50 sticky top-0 z-40 px-10 flex items-center justify-between">
          <div>
            <motion.h2
              key={activeTab}
              ...
              className="font-black text-2xl tracking-tight text-stone-950"
            >
              {navItems.find(i => i.id === activeTab)?.label}
            </motion.h2>
            <p className="text-sm text-stone-500 font-black">Elevating your restaurant experience</p>
          </div>
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 px-5 py-2.5 bg-white rounded-xl border border-stone-200 shadow-sm text-sm font-black text-stone-950">
              <Clock size={16} className="text-red-500" />
              Portal Active
            </div>
            <button type="button" className="w-12 h-12 rounded-xl bg-white border border-stone-200 shadow-sm flex items-center justify-center text-stone-400 hover:text-red-500 hover:border-red-100 transition-all relative">
              <Bell size={20} />
        ...
        <div className="p-10 max-w-[92rem] mx-auto">
            ...
            {isSubmitted ? (
              ...
              >
                <div className="bg-white rounded-[34px] border border-stone-200 shadow-[0_22px_60px_rgba(28,10,8,0.22)] p-8 md:p-12 text-center">
                  ...
                  <p className="text-[#B07D69] text-2xl font-bold mb-8">Your menu update request has been sent to Petpooja team.</p>
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-4">
                    <button
                      ...
                      className="min-w-56 px-7 py-4 rounded-2xl bg-red-600 text-white font-black text-2xl shadow-[0_12px_28px_rgba(225,29,72,0.4)] hover:bg-red-700 transition-all"
                    >
                      📧 View Email
                    </button>
                    <button
                      ...
                      className="min-w-44 px-7 py-4 rounded-2xl bg-blue-600 text-white font-black text-2xl shadow-[0_12px_28px_rgba(37,99,235,0.35)] hover:bg-blue-700 transition-all"
                    >
                      ✓ Done
                    </button>
                  </div>
                    ...
                    >
                      <div className="flex items-start justify-between gap-4 mb-6">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            <p className="text-3xl font-black text-stone-950">Email Preview</p>
                            <p className="text-stone-500 font-bold">Your request has been formatted as an email</p>
                          </div>
                        </div>
                        <button
                          type="button"
                      ...
                      <div className="rounded-2xl border border-stone-200 overflow-hidden">
                        ...
                        <div className="px-5 py-4 space-y-3 border-b border-stone-100 text-[15px]">
                          <div className="flex gap-4"><span className="w-20 text-stone-500 font-black">From</span><span className="font-bold text-stone-900">{emailFrom}</span></div>
                          <div className="flex gap-4"><span className="w-20 text-stone-500 font-black">To</span><span className="font-bold text-stone-900">support@petpooja.com</span></div>
                          <div className="flex gap-4"><span className="w-20 text-stone-500 font-black">Subject</span><span className="font-black text-stone-950">{emailSubject}</span></div>
                        </div>
  ...
  return (
    <div className="space-y-12">
      ...
      <TiltCard interactive={false}>
        <div className="bg-stone-900 rounded-[40px] p-20 relative overflow-hidden shadow-2xl">
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-red-600/10 blur-[120px] rounded-full -mr-64 -mt-64 animate-pulse" />
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-7xl font-black text-white tracking-tighter mb-6 leading-[0.95]">
              Update Your <br />
            ...
            <p className="text-stone-300 max-w-lg text-xl leading-relaxed mb-10 font-bold">
          ...
          <motion.div 
            ...
            className="absolute right-16 top-1/2 -translate-y-1/2 text-[200px] opacity-20 select-none pointer-events-none filter drop-shadow-[0_20px_30px_rgba(232,0,28,0.5)]"
          >
            🍱
          </motion.div>
        </div>
              ...
              <div className="flex gap-4">
                {['Single Outlet', 'Multiple Outlets'].map((type) => (
                  <button
                    ...
                    className={`px-8 py-4 rounded-full font-black text-sm uppercase tracking-widest transition-all border-2 flex items-center gap-3 ${
      ...
      <div className="flex justify-center pt-8">
        <motion.button
          ...
          className={`px-20 py-7 rounded-[24px] font-black text-2xl transition-all ${
            canSubmit
...
function StepCard({ step, title, icon: Icon, color, children, isComplete }: any) {
  ...
  return (
    <TiltCard interactive={false}>
      <div className={`rounded-[32px] p-12 border h-full min-h-[21rem] shadow-[0_14px_28px_rgba(26,8,6,0.08)] relative overflow-hidden group transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(26,8,6,0.14)] ${
        isComplete 
        ...
        <div className="flex items-center gap-5 mb-8 relative z-10">
          <div className={`w-16 h-16 rounded-2xl flex items-center justify-center shadow-inner border transition-all duration-500 ${
            isComplete 
          ...
          <div>
            ...
            <h3 className="font-black text-2xl text-stone-950">{title}</h3>
          </div>
        </div>
        <div className="relative z-10">
          {children}
  ...
  return (
    <div className="space-y-10">
      ...
      <div ref={pdfRef} className="bg-white rounded-[28px] p-8 border border-stone-200 shadow-sm">
        ...
        {pdfUrl ? (
          <iframe title="Menu PDF sample" src={pdfUrl} className="w-full h-[760px] rounded-xl border border-stone-200 bg-stone-50" />
        ) : (
...
function GuideHeader({ title, hindiTitle, description, icon: Icon, color }: any) {
  return (
    <div className="bg-white rounded-[40px] p-12 border border-red-50 shadow-sm relative overflow-hidden group">
      ...
      <div className="relative z-10 flex items-center gap-10">
        <motion.div 
          ...
          className={`w-24 h-24 rounded-[32px] bg-stone-50 ${color} flex items-center justify-center shadow-inner border border-stone-100`}
        >
          <Icon size={48} />
        </motion.div>
        <div>
          <div className="flex items-baseline gap-4 mb-3">
            <h2 className="text-5xl font-black text-stone-950 tracking-tight">{title}</h2>
            <span className="text-3xl font-black text-stone-200">/</span>
            <h2 className="text-4xl font-black text-stone-600">{hindiTitle}</h2>
          </div>
          <p className="text-stone-600 text-2xl font-black">{description}</p>
        </div>
      </div>
    </div>
  );
...
function GuideStep({ number, title, hindi, content }: any) {
  return (
    <TiltCard>
      <div className="bg-white rounded-[32px] p-10 border border-red-50 h-full shadow-sm hover:border-red-100 transition-all group relative overflow-hidden">
        ...
        <div className="flex items-center gap-5 mb-8 relative z-10">
          <div className="w-14 h-14 rounded-2xl bg-stone-50 text-stone-950 flex items-center justify-center text-xl font-black shadow-inner border border-stone-100 group-hover:bg-red-500 group-hover:text-white transition-all group-hover:scale-110">
            {number}
          </div>
          <div>
            <h4 className="font-black text-stone-950 text-xl uppercase tracking-widest">{title}</h4>
            <p className="text-[12px] font-black text-stone-500 uppercase tracking-[0.2em]">{hindi}</p>
          </div>
        </div>
        <p className="text-stone-600 font-black text-lg leading-relaxed relative z-10">{content}</p>
      </div>
    </TiltCard>
  );
}
